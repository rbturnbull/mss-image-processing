...
To illustrate these tools, we will use a case study of Jerusalem Hagios Stavros 26, an eleventh-century Greek-Arabic lectionary written on parchment, with the Gregory-Aland number L1023. The Greek text appears on the left column and the Arabic text on the right, with the manuscript ordered from left to right, as discussed in [*Codex Sinaiticus Arabicus and Its Family*](https://brill.com/display/title/69300).
